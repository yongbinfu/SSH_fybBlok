        ...
        <div class="am-u-sm-12 am-u-md-3">
            <div class="am-input-group am-input-group-sm">
                <input type="text" class="am-form-field" id="input_search"
                       value="<s:property value="#parameters.content"/>">
...
<script>
    ...
    $("#page").paging({
        ...
        callback: function (num) {
            ...
            $(window).attr('location', '${ctx}/article_pageList.action?currPage=' + num + '&content=' + content);
        }
    });

    $("#add").click(function () {
        $(window).attr('location', '${ctx}/location_addArticle.action');
    });

    $("#input_search_btn").click(function () {
        var content = $("#input_search").val();
        $(window).attr('location', '${ctx}/article_pageList.action?content=' + content);
    })
</script>
